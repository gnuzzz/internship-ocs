...
public class JPACatalogService {
    ...
    public List<Pair<Author, Long>> getAuthorsWithBooksCount() throws CatalogException {
        try {
            return repository.getAuthorsWithBooksCount();
        } catch (Exception e) {
            throw new CatalogException("Can't get authors with books count ", e);
        }
    }
    ...
    public PopularScienceBook createPopularScienceBook(String title, List<Author> authors, Category category, String image, String scienceField) throws CatalogException {
        try {
            PopularScienceBook book = repository.createPopularScienceBook(title, authors, category, image, scienceField);
            return book;
        } catch (Exception e) {
    ...
    public Book createScienceFictionBook(String title, List<Author> authors, Category category, String image, String genre) throws CatalogException {
        try {
            ScienceFictionBook book = repository.createScienceFictionBook(title, authors, category, image, genre);
            return book;
        } catch (Exception e) {
            throw new CatalogException("Can't create book", e);
        }
    ...
    public Book createSatireBook(String title, List<Author> authors, Category category, String image) throws CatalogException {
        try {
            Book book = repository.createSatireBook(title, authors, category, image);
            return book;
        } catch (Exception e) {
            throw new CatalogException("Can't create book", e);
        }
